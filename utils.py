...
#        save_npys(sample_params, './samples/experiment/test_params_{:04d}.npy'.format(i))
        depth = W.shape[0]
...
def visualize(sess, dcgan, config, option):
  ...
  if option == 0:
    ...
    newpath = './samples/experiment/test_set_{}'.format(now)
    ...
    for idx in xrange(100):
      ...
      save_images(samples, [image_frame_dim, image_frame_dim], './samples/scatter/test_arange_%s.png' % (idx))    
